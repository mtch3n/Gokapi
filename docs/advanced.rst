...
+-------------------------------------+-------------------------------------------------------------------------------------------------------------------------+-----------------+-----------------------------+
| GOKAPI_DISABLE_BUILTIN_UI           | Disables the built-in web interface, including the anonymous download and hotlink pages, if set to true.                | No              | false                       |
|                                     |                                                                                                                         |                 |                             |
...
+-------------------------------------+-------------------------------------------------------------------------------------------------------------------------+-----------------+-----------------------------+
| GOKAPI_DISABLE_HOTLINKS             | Disables the creation of hotlinks, if set to true. Existing hotlinks are purged on startup,                             | No              | false                       |
|                                     |                                                                                                                         |                 |                             |
|                                     | so that no password-free URL keeps serving a file after this is enabled                                                 |                 |                             |
+-------------------------------------+-------------------------------------------------------------------------------------------------------------------------+-----------------+-----------------------------+
| GOKAPI_DOWNLOAD_SESSION_LEEWAY      | Sets how long a download window stays open. A window opens when a request spends one of the                             | No              | 0                           |
|                                     |                                                                                                                         |                 |                             |
...
+-------------------------------------+-------------------------------------------------------------------------------------------------------------------------+-----------------+-----------------------------+
| GOKAPI_DOWNLOAD_SESSION_SIGN_KEY    | The HMAC key used to sign download session tokens. Required whenever DownloadLeeway is                                  | No              |                             |
|                                     |                                                                                                                         |                 |                             |
...
+-------------------------------------+-------------------------------------------------------------------------------------------------------------------------+-----------------+-----------------------------+
| GOKAPI_ENCRYPTION_KEY_B64           | Sets the master encryption key, encoded as base64 of exactly 32 raw bytes, e.g. supplied                                | No              |                             |
|                                     |                                                                                                                         |                 |                             |
...
+-------------------------------------+-------------------------------------------------------------------------------------------------------------------------+-----------------+-----------------------------+
| GOKAPI_FILEREQUEST_RETENTION        | Sets how long a file request is kept, together with every file it received and its upload                               | No              | 0                           |
|                                     |                                                                                                                         |                 |                             |
...
+-------------------------------------+-------------------------------------------------------------------------------------------------------------------------+-----------------+-----------------------------+
| GOKAPI_MAX_EXPIRY                   | Sets the furthest expiry allowed for an upload. Any upload that requests a longer                                       | No              | 0                           |
|                                     |                                                                                                                         |                 |                             |
...
|                                     | Default 10240 = 10GB                                                                                                    |                 |                             |
+-------------------------------------+-------------------------------------------------------------------------------------------------------------------------+-----------------+-----------------------------+
| GOKAPI_METADATA_RETENTION           | Sets how long a file's metadata record is kept as history after its content is disposed of                              | No              | 7d                          |
|                                     |                                                                                                                         |                 |                             |
...
+-------------------------------------+-------------------------------------------------------------------------------------------------------------------------+-----------------+-----------------------------+
| GOKAPI_MIN_LENGTH_PASSWORD          | Sets the minimum password length. Regardless of this value, every password                                              | No              | 8                           |
|                                     |                                                                                                                         |                 |                             |
|                                     | must also contain a lowercase letter, an uppercase letter, a number and a special character. Value must be 6 or greater |                 |                             |
+-------------------------------------+-------------------------------------------------------------------------------------------------------------------------+-----------------+-----------------------------+
