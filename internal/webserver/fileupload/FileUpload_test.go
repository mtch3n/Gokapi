...
func TestMain(m *testing.M) {
	testconfiguration.CreateWithPort(false, test.PortFileupload)
	configuration.Load()
...
func TestProcess(t *testing.T) {
	...
	testUrl := test.Url(test.PortFileupload)
	test.IsEqualString(t, result.FileInfo.UrlDownload, testUrl+"/d?id="+result.FileInfo.Id)
	test.IsEqualString(t, result.FileInfo.UrlHotlink, testUrl+"/downloadFile?id="+result.FileInfo.Id)
