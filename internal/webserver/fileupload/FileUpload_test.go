...
func TestMain(m *testing.M) {
	testconfiguration.CreateWithPort(false, testconfiguration.PortFileupload)
	configuration.Load()
...
func TestProcess(t *testing.T) {
	...
	test.IsEqualString(t, result.FileInfo.UrlDownload, "http://127.0.0.1:53846/d?id="+result.FileInfo.Id)
	test.IsEqualString(t, result.FileInfo.UrlHotlink, "http://127.0.0.1:53846/downloadFile?id="+result.FileInfo.Id)
