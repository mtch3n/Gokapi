...
type paramFilesModify struct {
	...
	// the user, exactly as on paramChunkComplete. It decides whether the new password may be
	// kept in encrypted form for GET /files/{id}/sharekey - a typed password never may.
